...
import { ParamsEditorDirective } from './params-editor.directive';
...
export class ParamsEditorComponent implements OnInit {
  ...
  @ViewChild(ParamsEditorDirective) peHost: ParamsEditorDirective;
  ...
  ngOnInit() {
    ...
    let viewContainerRef = this.peHost.viewContainerRef;
